      ...
      <div id="main">
        <div className="container">
          ...
          <div className="ques-area">
            ...
            <h5>Toxic Screen,Snake bite,poision cloud,viper's PIT </h5>
          </div>
            {currChar.abilities.join()}
            <div className="options">
              <button className="btn" onClick={changeChar}>Sova</button>
                <button className="btn" onClick={changeChar}>Breach</button>
                <button className="btn" onClick={changeChar}>Raze</button>
                <button className="btn"  onClick={scoreHandler}>Viper</button>
            </div>
            </div>
          </div>
        {/* </div> */}
